...
export const CASE_STUDIES: CaseStudy[] = [
  /* ---------------------------------------------------------------- */
  {
    ...
    images: [
      { src: "/media/cad/master-bathroom-plan.webp", alt: "Master bathroom general arrangement plan with dimensions and fixture setting-out", width: 3200, height: 2260, caption: "Master bathroom — general arrangement plan" },
      { src: "/media/cad/master-bathroom-elevation.webp", alt: "Master bathroom wall elevation showing bathtub and window setting-out", width: 3200, height: 2260, caption: "Wall 1 — bathtub and window elevation" },
      { src: "/media/cad/master-bathroom-vanity.webp", alt: "Master bathroom wall elevation showing vanity and WC wall", width: 3200, height: 2260, caption: "Wall 2 — vanity and WC elevation" },
      { src: "/media/cad/master-bathroom-shower.webp", alt: "Master bathroom wall elevation showing walk-in shower", width: 3200, height: 2260, caption: "Wall 3 — walk-in shower elevation" },
      { src: "/media/cad/cigar-lounge-layout.webp", alt: "Cigar lounge general furniture layout plan", width: 3200, height: 2260, caption: "Cigar lounge — furniture layout" },
      { src: "/media/cad/cigar-lounge-ceiling.webp", alt: "Cigar lounge reflected ceiling plan showing coffered ceiling and lighting arrangement", width: 3200, height: 2260, caption: "Cigar lounge — reflected ceiling plan" },
      { src: "/media/cad/cigar-lounge-flooring.webp", alt: "Cigar lounge herringbone flooring setting-out plan", width: 3200, height: 2260, caption: "Cigar lounge — herringbone flooring layout" },
      { src: "/media/cad/feature-wall-overview.webp", alt: "Custom interior feature walls general arrangement and layout drawing", width: 3200, height: 2199, caption: "Feature walls — general arrangement" },
      { src: "/media/cad/toilet-elevations.webp", alt: "Toilet feature wall elevation detailing vanity and mirror", width: 3200, height: 2199, caption: "Toilet feature wall — elevation detail" },
      { src: "/media/cad/wash-elevations.webp", alt: "Wash feature wall elevation detailing decorative panelling and fixtures", width: 3200, height: 2199, caption: "Wash feature wall — panelling and fixture elevation" },
      { src: "/media/cad/stair-wall-detail.webp", alt: "Stair feature wall architectural joinery construction detail drawing", width: 2536, height: 3200, caption: "Stair feature wall — joinery construction detail" },
    ],
    ...
    seo: {
      ...
      image: "/media/cad/master-bathroom-plan.webp",
    },
  },
