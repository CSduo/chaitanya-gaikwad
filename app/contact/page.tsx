...
export default function ContactPage() {
  ...
  return (
    <>
      ...
      {/* 02–07 — Enquiry form with Contact Priority Bar */}
        ...
        <Container width="page">
          ...
          <div className="mb-12 rounded-lg border border-rule-strong bg-paper p-6 sm:p-8">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              ...
              {/* Action Buttons — Structured 4-Way Box (2x2 Grid) */}
              <div className="grid grid-cols-2 gap-2.5 sm:gap-3 w-full sm:w-auto max-w-md sm:max-w-lg">
                {/* Horizontal Line 1: UK Phone & WhatsApp */}
                <a
                  href={WHATSAPP.uk.tel}
                  className="flex min-h-[46px] items-center justify-center gap-2 rounded-xs border border-rule-strong bg-surface px-3 text-xs font-semibold tracking-tight text-ink transition-colors hover:border-ink text-center"
                  aria-label={`Call UK Line directly at ${WHATSAPP.uk.number}`}
                >
                  <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-ink-muted shrink-0">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
                  </svg>
                  <span className="truncate">Call UK: {WHATSAPP.uk.number}</span>
                </a>
                ...
                <a
                  ...
                  className="flex min-h-[46px] items-center justify-center gap-2 rounded-xs bg-ink px-3 text-xs font-semibold tracking-tight text-paper transition-colors hover:bg-accent text-center"
                >
                  <span>WhatsApp UK</span>
                  <span aria-hidden="true">&#8599;</span>
                </a>

                {/* Horizontal Line 2: India Phone & WhatsApp */}
                <a
                ...
                >
                  ...
                  <span className="truncate">Call India: {WHATSAPP.india.number}</span>
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex min-h-[46px] items-center justify-center gap-2 rounded-xs border border-rule px-3 text-xs font-semibold tracking-tight text-ink transition-colors hover:border-ink hover:bg-paper-deep text-center"
                >
