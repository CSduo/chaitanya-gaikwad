      ...
      <section className="deco-host relative border-b border-zinc-800 bg-black text-white overflow-hidden">
        ...
        <Container width="page" className="relative z-10 pb-16 pt-12 sm:pt-16 lg:pb-24 lg:pt-20">
          <div className="max-w-3xl xl:max-w-4xl">
            ...
            <p className="mt-5 max-w-2xl text-[0.9375rem] leading-relaxed text-zinc-300 sm:mt-6 sm:text-[1.0625rem] sm:leading-relaxed">
            ...
            <div className="mt-10 max-w-xl border-t border-zinc-800/90 pt-6 sm:mt-12 sm:pt-7">
